...
local Name = "塔石吞噬"
local Tip = "塔石吞噬("..hColor.greenLight("A")..") - "..hColor.yellow("100黄金")
obj.Order = "absorb"
obj.DataF1 = "absorb"
obj.Name = Name
obj.Tip = Tip
...
local Name = "木换金"
local Tip = "木换金("..hColor.greenLight("C")..") - "..hColor.green("1木头")
obj.Order = "ancestralspirittarget"
obj.DataF1 = "ancestralspirittarget"
obj.Name = Name
obj.Tip = Tip
obj.Hotkey = "C"
obj.Ubertip = "以1木头换取20金币"
obj.Buttonpos1 = 2
obj.Buttonpos2 = 2
obj.hero = 0
obj.levels = 1
...
obj.Tip = Tip
obj.Hotkey = "V"
obj.Ubertip = "将信使身上所有的物品评分，随机升华为一个新的物品|n物品必须大于2件以上才可升华"
obj.Buttonpos1 = 3
obj.Buttonpos2 = 2
obj.hero = 0
obj.levels = 1

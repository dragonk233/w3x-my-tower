...
local createTowerShadowUnit = function(v,towersTi,tlv)
    local sobj = slk.unit.ogru:new("this_tower_shadow_" .. v.INDEX .. towersTi)
...
for tlv, tow in pairs(towers) do
    if tow ~= nil then
        for i, v in pairs(tow) do
            ...
            local Ubertip = ""
            local obj = slk.unit.Hpal:new("towers_" .. thisIndex .. towersTi)
            ...
            --塔基的属性说明
            local dobj = slk.ability.Aamk:new("towerOriginAbli_" .. thisIndex .. towersTi)
            ...
            -- 塔基物品
            local iobj = slk.item.gold:new("towers_items_" .. thisIndex .. towersTi)

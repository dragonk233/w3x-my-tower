            ...
            for k, v in ipairs(game.towersOriginSkill) do
                ...
                if (abid ~= nil and v.Val ~= nil) then
                    ...
                    if (hskill.has(u, abid)) then
                        ...
                        elseif
                            (name == "巾帼" or name == "剑圣" or name == "气定神闲" or name == "风风拳" or name == "牙牙拳" or
                                name == "电激穴道" or
                                name == "加速")
                         then
                        ...
                        elseif
                            (name == "蛇皮" or name == "修仙之体" or name == "恶魔之躯" or name == "魔爪" or name == "聚气" or
                                name == "海浪之形")
                         then
                        ...
                        elseif (name == "古代帝王") then
                            hattr.set(
                                u,
                                0,
                                {str_green = "+" .. Val[1], agi_green = "+" .. Val[2], int_green = "+" .. Val[3]}
                            )
                        ...
                        elseif (name == "机械之心") then
                            hattr.set(
                                u,
                                0,
                                {str_green = "+" .. Val[1], agi_green = "+" .. Val[2], defend = "+" .. Val[3]}
                            )
                        end
                        if (name == "深渊之刃") then
                            hattr.set(
                        ...
                        if
                            (name == "震荡光弹" or name == "暴力倾向" or name == "旋风" or name == "魅惑" or name == "撸战棍" or
                                name == "恍惚灯路" or
                                name == "晴天霹雳" or
                                name == "沉痛打击" or
                                name == "深情一吻")

        ...
        function(t)
            ...
            elseif (abliOps.Name == "恶龙吞日") then
                hattr.set(
                    u,
                    0,
                    {attack_damage_type = opt .. "dargon", natural_dargon = opt .. (level * abliOps.Val[1])}
                )
            ...
            elseif (abliOps.Name == "邪魅之虫") then
                hattr.set(
                    u,
                    0,
                    {attack_damage_type = opt .. "insect", natural_insect = opt .. (level * abliOps.Val[1])}
                )
            ...
            elseif (abliOps.Name == "圣封护盾") then
                hattr.set(
                    u,
                    0,
                    {defend = opt .. (level * abliOps.Val[1]), resistance = opt .. (level * abliOps.Val[2])}
                )

items_defend1 = {
    ...
    },
    {
        ...
        goldcost = 875,
        lumbercost = 0,
        Art = "ReplaceableTextures\\CommandButtons\\BTNSteelArmor.blp",
        powerup = 0,
        sellable = 1,
        pawnable = 1,
        droppable = 1,
